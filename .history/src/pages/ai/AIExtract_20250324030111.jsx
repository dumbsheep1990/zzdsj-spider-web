...
import { BrainOutlined, QuestionCircleOutlined } from '@ant-design/icons';
...
function AIExtract() {
    ...
    return (
        <div className="ai-extract">
            <Title level={4}>AI 内容提取</Title>
            <Paragraph>
                使用 LLM（大型语言模型）智能提取网页内容，支持多种提取模式。
            </Paragraph>

            <StyledCard title="提取配置">
                <Form
                    form={form}
